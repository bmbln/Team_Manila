...
# we only need the prices and inner/outer district variables at the moment
df <- df %>% select( c( city , p_coke , p_snickers ) )
...
kable( testing , digits = 4, 
       ...
       col.names = c('Country','Mean','SE of the Mean','Num.Obs','t-stat','p-val'),
